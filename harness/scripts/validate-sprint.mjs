...
const registryFor=baselineId=>{
  ...
  return new Map((read(rp).entries||[]).filter(e=>(e.contract_status==="ACTIVE" && e.required_for_build_freeze===true) || e.contract_status==="READY_FOR_IMPLEMENTATION").map(e=>[e.acceptance_id,e]));
};
